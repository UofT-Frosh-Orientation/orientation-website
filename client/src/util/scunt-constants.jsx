  ...
  start: [
    {
      ...
      items: [
        ...
        'Have officially registered for the event via F!rosh Week 2T2.',
      ],
    },
    {
      title: 'Registration',
      ...
      items: [
        ...
        'It will conclude the same day F!rosh Week registration does, Sunday September 4th right before F!rosh Week.',
    ...
    },
    {
      ...
      items: [
        ...
        '<strong>***The item must be on the list.***</strong>',
        'The item should not bring harm to the performant, including but not limited to: physical harm, illness, inebriety, allergic reactions, vomiting, or anything else that requires the attention of SkuleTM Patrol. If you believe that doing this item would cause any of this to occur to you, do not do it.',
        '<strong>***The item must be on the list.***</strong>',
