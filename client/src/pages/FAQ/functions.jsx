...
export async function getQuestions(setSnackbar) {
  ...
  return [
    ...
    },
    {
      ...
      answer:
        'Register for F!rosh Week at orientation.skule.ca starting July 2nd! Follow us on Instagram @froshweek and join the F!rosh Week 2T6 Discord server. To stay up to date throughout the summer! Important links can also be found at linktr.ee/froshweek. Link to Discord server: https://discord.gg/Fnxr7tp34E',
