  ...
  return (
    <>
      <section className="sz-wrapper-landing">
        <div className="sz-landing-text">2023 Fall</div>
        ...
        <div className="szlanding-logo-container">
          ...
          <p>Check out our F!rosh Instagram page</p>
          ...
          <p>Check out our FroshNoMore Instagram page</p>
        </div>
      </section>
    </>
  );
